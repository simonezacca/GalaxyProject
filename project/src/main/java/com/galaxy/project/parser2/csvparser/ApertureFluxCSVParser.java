...
import com.galaxy.project.parser2.csvheader.ApertureFluxCSVHeader;
...
public class ApertureFluxCSVParser extends ACSVParser<RowFlux> {

	private List<SpectralLine> spectralLines;
	
	public ApertureFluxCSVParser(String csvFileName) {
		super(csvFileName,24);
		setHeaderClass(ApertureFluxCSVHeader.class);
...
//		
	...
	public static void main(String[] args) {
		...
		String csvFilePath = "/Users/antonio/Downloads/FileProgetto/MRTable11_C_3x3_5x5_flux.csv";
		
		ApertureFluxCSVParser parser = new ApertureFluxCSVParser(csvFilePath);
		try {
			parser.parse();
		} catch (IOException e) {
			e.printStackTrace();
